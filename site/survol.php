<?php 
	...
	$pagetitre = "Survol berline Accord";
...
?>
	...
	<article class="centercontent content">
		...
		<p>Elle comporte aussi le nouveau système d’affichage d’angle mort LaneWatchMC offert dans certaines versions et l’affichage multifonctions intelligent de 8 po qui vous permet de recevoir des messages textes et des courriels. Vous y trouverez aussi d’autres technologies novatrices comme les systèmes d’avertissement de sortie de voie 8 et d’alerte de collision avant (FCW)4 offerts dans certaines versions.</p>
